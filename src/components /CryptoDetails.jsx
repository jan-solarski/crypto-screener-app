...
const Indicator = ({ currentPrice, high, low }) => {
  ...
  useEffect(() => {
    let total = high - low;
    let green = ((high - currentPrice) * 100) / total;
...
export const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    <div
      className="fixed z-20 top-0 w-full h-full bg-gray-200 bg-opacity-30 backdrop-blur-sm flex items-center justify-center"
      onClick={close}
    >
      <div
          ...
          <div className="flex md:flex-row flex-col items-center justify-between lg:h-full h-auto w-full p-4 relative">
            <div className="flex flex-col md:w-[45%] w-full h-full pr-2">
              <div className="flex w-full items-center">
                ...
                <span className="text-sm py-0.5 px-2.5 ml-2 bg-cyan bg-opacity-25 rounded uppercase">
                  {coinData.symbol}
                </span>
              </div>
